...
##### Ubiquitous B-Trees
B-Tree는 도서관의 방대한 카탈로그 방처럼 생각할 수 있습니다: 먼저 올바른 캐비닛을 선택한 다음 캐비닛에 있는 올바른 선반, 선반에 있는 올바른 서랍을 선택한 다음 서랍에 있는 카드를 훑어보고 찾고자 하는 책을 찾아야 합니다. B-Tree는 찾고자 하는 데이터를 빠르게 탐색할 수 있는 계층 구조를 구축합니다.
