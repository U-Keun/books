...
요약하면, 디스크 상의 구조는 목표로 하는 저장소의 특성을 염두에 두고 설계되며, 일반적으로는 디스크에 접근하는 횟수를 줄이는 방향으로 최적화됩니다. 이 최적화는 데이터의 지역성을 개선하거나 데이터 구조의 내부적인 표현을 최적화하거나 페이지 밖의 포인터 개수를 줄이는 등의 방식으로 구현할 수 있습니다.
